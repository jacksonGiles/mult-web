  ...
  <div ref="menuRef" class="menu">
    <div class="menu-links">
      ...
      <div class="social-icons">
        <a
          href="https://twitter.com/mult_band"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/mult.band/"
          target="_blank"
          alt="Link to Bandcamp"
          class="social-link"
        >
        ...
        <a
          href="https://linktr.ee/mult_band?utm_source=linktree_profile_share&ltsid=417d5800-87e9-4aad-a8ad-a2a9185f6836"
          target="_blank"
          alt="Link to Bandcamp"
          class="social-link"
        >
